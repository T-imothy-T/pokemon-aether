...
static const struct LevelUpMove sMudkipLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 3, MOVE_WATER_GUN),
    LEVEL_UP_MOVE( 6, MOVE_ICY_WIND),       // early winter control
    LEVEL_UP_MOVE( 9, MOVE_TWISTER),        // early dragon identity
    LEVEL_UP_MOVE(12, MOVE_MIST),           // frosty aura
    LEVEL_UP_MOVE(15, MOVE_BRINE),          // real Water STAB before evo
    LEVEL_UP_MOVE(16, MOVE_FLIP_TURN),      // pivot right as it evolves
...
static const struct LevelUpMove sMarshtompLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_AQUA_JET),       // evo tempo tool
    LEVEL_UP_MOVE( 1, MOVE_BITE),
    LEVEL_UP_MOVE( 1, MOVE_BRINE),
    LEVEL_UP_MOVE( 1, MOVE_WATER_GUN),
    LEVEL_UP_MOVE(18, MOVE_ICE_FANG),
    LEVEL_UP_MOVE(22, MOVE_BREAKING_SWIPE), // modern atk control
    LEVEL_UP_MOVE(26, MOVE_DRAGON_TAIL),    // phazing utility
    LEVEL_UP_MOVE(30, MOVE_SCALD),          // modern Water STAB
    LEVEL_UP_MOVE(34, MOVE_DRAGON_HAMMER),   // reliable Dragon STAB
    LEVEL_UP_MOVE(36, MOVE_DRAGON_HAMMER),   // ensure learned at evo
    LEVEL_UP_MOVE(42, MOVE_CRUNCH),
    LEVEL_UP_MOVE(46, MOVE_EARTHQUAKE),
    LEVEL_UP_MOVE(53, MOVE_OUTRAGE),        // late high-risk payoff
    LEVEL_UP_END
};


static const struct LevelUpMove sSwampertLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_DRAGON_DANCE),   // evo spike
    LEVEL_UP_MOVE( 1, MOVE_AQUA_JET),
    LEVEL_UP_MOVE( 1, MOVE_DRAGON_BREATH),
    LEVEL_UP_MOVE(38, MOVE_AQUA_TAIL),
    LEVEL_UP_MOVE(42, MOVE_CRUNCH),
    LEVEL_UP_MOVE(46, MOVE_LIQUIDATION),    // upgraded Water STAB
    LEVEL_UP_MOVE(50, MOVE_ICE_BEAM),       // special coverage
    LEVEL_UP_MOVE(54, MOVE_HYDRO_PUMP),     // nuke
    LEVEL_UP_MOVE(58, MOVE_OUTRAGE),
    LEVEL_UP_MOVE(62, MOVE_DRACO_METEOR),   // endgame (tutor-style OK)
    LEVEL_UP_END
};
